...
{
    public class IntegerSyntax : AlAdvancedTypeSyntax<PredefinedTypeSyntax>
    {
        ...
        public override string GetInitializer(EqualsValueClauseSyntax valueClauseSyntax) => valueClauseSyntax.ToFullString();

        public override string ParseInitializer(string value) => value;

        internal override void ParseCSharp()
        {
            CSharpType = SyntaxFactory.PredefinedType(SyntaxFactory.ParseToken(Keyword));
        }
    }
}
